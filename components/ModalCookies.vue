<template>
  <div
    class="fixed top-0 bottom-0 left-0 right-0 z-40 flex flex-col items-center justify-center w-full h-full overflow-x-hidden overflow-y-auto bg-dark dark:bg-light opacity-95"
  >
    <div
      class="relative z-50 w-full mt-6 mb-3 overflow-auto rounded-lg shadow-lg opacity-100 sm:w-2/6 md:w-2/6 h-4/6 bg-light dark:bg-dark"
    >
      <div class="flex flex-col justify-center align-center">
        <div
          class="flex justify-between px-5 py-4 border-2 border-light dark:border-dark"
        >
          <div>
            <svg
              class="inline w-6 h-6 text-light-secondary dark:text-dark-secondary"
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
            ...
            >
              ...
              ></path></svg
            ><span
              class="text-base font-bold text-light-secondary dark:text-dark-secondary"
      ...
      <div class="flex w-full flex-start">
        <div
          class="px-5 py-2 text-sm font-bold text-light-primary dark:text-dark-primary"
        >
        ...
        >
          <ul class="flex flex-wrap cursor-pointer">
            <li
              ...
              :class="
                tabActive == 0
                  ? 'bg-light-primary text-light dark:bg-dark-primary dark:text-dark'
                  : 'bg-light text-light-primary dark:bg-dark dark:text-dark-primary'
              "
              @click="tabActive = 0"
            >
              Acerca de las
      ...
      <div v-show="tabActive == 1" class="flex flex-col w-full">
        ...
        <div class="w-full my-2 div-center">
          <div
            class="flex flex-col justify-center w-5/6 px-6 py-3 rounded-lg bg-light-accent dark:bg-dark-accent"
          >
            <div class="flex items-start content-start justify-start">
              <div
                class="flex text-sm flex-start text-light-primary dark:text-dark-secondary"
              >
                Nombre:
              </div>
              <div
                class="flex ml-2 text-sm font-bold flex-start text-light-secondary dark:text-dark"
              >
                vercookies
              </div>
            </div>
            <div class="flex items-start content-start justify-start">
              ...
              <div
                class="flex ml-2 text-sm flex-start text-light-secondary dark:text-dark"
              >
                hipoteca10.es
              </div>
            </div>
            <div class="flex items-start content-start justify-start">
              ...
              <div
                class="flex ml-2 text-sm text-justify flex-start text-light-secondary dark:text-dark"
              >
